...
async function startStdioServer() {
  console.log('Starting URL Content Saver MCP Server with stdio transport...');
...
async function startHttpServer() {
  console.log(`Starting URL Content Saver MCP Server with HTTP transport on port ${port}...`);
  ...
  // Start the server
  app.listen(port, () => {
    console.log(`URL Content Saver MCP Server running with HTTP transport on port ${port}`);
  });
}
